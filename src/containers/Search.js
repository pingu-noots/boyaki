...
export default function Search() {
  ...
  return (<React.Fragment>
    ...
    <PostList isLoading={isLoading} posts={posts} getAdditionalPosts={getAdditionalPosts} listHeaderTitle={'Search'} listHeaderTitleButton={<React.Fragment > <TextField label="Enter Keywords" multiline="multiline" rowsMax="3" variant="filled" value={query} onChange={handleChange} fullWidth="fullWidth" margin="normal"/>
